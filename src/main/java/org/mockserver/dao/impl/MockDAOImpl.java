...
import org.mockserver.dao.repositories.MockRequestParamRepository;
...
public class MockDAOImpl implements MockDAO {
	...
	@Autowired
	private MockRequestParamRepository mockRequestParamRepository;

	@Override
	public void createMockParams(List<MockRequestParam> params) throws Exception {

		log.info("createMockParam(MockRequestParam(param))");

		for (MockRequestParam param: params) {

			createMockParam(param);
		}
	}
	...
	public void createMockParam(MockRequestParam param) throws Exception {
		...
		mockRequestParamRepository.save(param);
